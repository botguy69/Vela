...
export function phaseFor(equity: number, continueToGoal = false): Phase {
  ...
  if (equity < 100) {
    return {
      ...
      minConf: 78,
      method: "trend",
      note: "Stage 1 · 3% · 2 at-risk, 3rd after 2× TP1/BE.",
    };
  }
  if (equity < 1000) {
    return {
      ...
      minConf: 78,
      method: "trend",
      note: "Stage 1 · 3% (1.8% after 3 losses). 2 at-risk, 3rd after 2× BE.",
    };
  }
  return {
    id: "grow",
    ...
    minConf: 78,
    method: "trend",
    note: "Stage 2: $1k → $10k. 3% / 1.8% size. 2 at-risk, 3rd after 2× BE. Stop at $10k.",
  };
}
